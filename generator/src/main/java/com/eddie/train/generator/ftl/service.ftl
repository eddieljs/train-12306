...
import com.eddie.train.member.domain.${Domain};
import com.eddie.train.member.domain.${Domain}Example;
import com.eddie.train.member.mapper.${Domain}Mapper;
import com.eddie.train.member.req.${Domain}QueryReq;
import com.eddie.train.member.req.${Domain}SavaReq;
import com.eddie.train.member.resp.${Domain}QueryResp;
